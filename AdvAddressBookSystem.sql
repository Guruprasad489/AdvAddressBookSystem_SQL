--UC1-- Create AddressBook Service DB
...
delete from AddressBook_Table where FirstName = 'abc' and LastName = 'xyz';
select * from AddressBook_Table;
...
('Virat', 'Kohli', 'RCB', 'Bangalore', 'Karnataka', 560040, 1231231235, 'virat@gmail.com', 'Family');
select * from AddressBook_Table;
